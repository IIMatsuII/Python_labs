...
# for current_collor in rainbow_colors:
#     start_point = sd.get_point(start_x, start_y)
#     end_point = sd.get_point(end_x, end_y)
#     sd.line(start_point=start_point, end_point=end_point,color=current_collor, width=4)
#     start_x += 5
#     # start_y += 5
#     end_x += 5
#     # end_y += 5
...
#     sd.circle(center_position=center_position, radius=400,color=current_collor, width=15)
#     start_y -= 15
